...
public static class MiscPatches
{
    ...
    [HarmonyPatch(typeof(FloatMenuOptionProvider_OpenThing), "GetSingleOptionFor")]
    public static void Postfix(FloatMenuOption __result, Thing clickedThing, FloatMenuContext context)
    {
        ...
        {
            __result = new("CannotOpen".Translate(t) + ": " + "VFED.CantOpenBiosecured".Translate().CapitalizeFirst(), null);
        }
    }
