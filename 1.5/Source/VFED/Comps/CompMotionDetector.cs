...
public abstract class CompMotionDetector : ThingComp
{
    ...
    protected virtual void Trigger(Thing initiator)
    {
        ...
        Find.SignalManager.SendSignal(new("MotionDetected", parent.Named("DETECTOR"), initiator.Named("DETECTED")));
    }
    ...
    private bool TriggerOn(Thing t) =>
     ...
     && (!Props.onlyPlayer || pawn.Faction.IsPlayerSafe()) && !pawn.IsPsychologicallyInvisible();
